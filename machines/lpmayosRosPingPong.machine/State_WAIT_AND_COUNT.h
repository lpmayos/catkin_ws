...
//
#ifndef __clfsm__lpmayosRosPingPong_State_WAIT_AND_COUNT_h__
#define __clfsm__lpmayosRosPingPong_State_WAIT_AND_COUNT_h__
...
#endif // defined(__gufsm__lpmayosRosPingPong_State_WAIT_AND_COUNT__)
