//
//lab2task2a_VarRefs.mm
//
//Automatically created through MiEditCLFSM -- do not change manually!
//
lab2task2a *_m = static_cast<lab2task2a *>(_machine);
...
ros_lab2task2a::RbuttonStatus	&srv= _m->srv;	///<
...
ros_lab2task2a::RsonarStatus	&srv2= _m->srv2;	///<
ros::ServiceClient	&client2= _m->client2;	///<
int	&distanceValue= _m->distanceValue;	///<
ros_lab2task2a::RlightStatus	&srv3= _m->srv3;	///<
