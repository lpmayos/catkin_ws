...
public:
    ...
    */
    ...
    @param devinfo A uint8_t* buffer to store the device information.
    @param bufsiz A size_t with the size of the buffer.
    */
    void getDeviceInfo(uint8_t *devinfo, size_t bufsiz);
