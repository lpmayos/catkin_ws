"""autogenerated by genpy from ros_lab2task2/Rrobot.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import ros_lab2task2.msg
import std_msgs.msg

class Rrobot(genpy.Message):
  _md5sum = "b873f2a5e02ba6f92c0c7cf005c8b275"
  _type = "ros_lab2task2/Rrobot"
...
"""
  ...
  _slot_types = ['std_msgs/Header','ros_lab2task2/Rmotor','ros_lab2task2/Rmotor']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.leftMotor is None:
        self.leftMotor = ros_lab2task2.msg.Rmotor()
      if self.rightMotor is None:
        self.rightMotor = ros_lab2task2.msg.Rmotor()
    else:
      self.Rrobot = std_msgs.msg.Header()
      self.leftMotor = ros_lab2task2.msg.Rmotor()
      self.rightMotor = ros_lab2task2.msg.Rmotor()
