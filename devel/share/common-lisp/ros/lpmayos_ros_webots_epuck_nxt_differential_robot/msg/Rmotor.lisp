...
(cl:defmethod cl:initialize-instance :after ((m <Rmotor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Rmotor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lpmayos_ros_webots_epuck_nxt_differential_robot-msg:<Rmotor> is deprecated: use lpmayos_ros_webots_epuck_nxt_differential_robot-msg:Rmotor instead.")))

(cl:ensure-generic-function 'Rmotor-val :lambda-list '(m))
(cl:defmethod Rmotor-val ((m <Rmotor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lpmayos_ros_webots_epuck_nxt_differential_robot-msg:Rmotor-val is deprecated.  Use lpmayos_ros_webots_epuck_nxt_differential_robot-msg:Rmotor instead.")
  (Rmotor m))

(cl:ensure-generic-function 'power-val :lambda-list '(m))
(cl:defmethod power-val ((m <Rmotor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lpmayos_ros_webots_epuck_nxt_differential_robot-msg:power-val is deprecated.  Use lpmayos_ros_webots_epuck_nxt_differential_robot-msg:power instead.")
  (power m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Rmotor>)))
  ...
  "lpmayos_ros_webots_epuck_nxt_differential_robot/Rmotor")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Rmotor)))
  "Returns string type for a message object of type 'Rmotor"
  "lpmayos_ros_webots_epuck_nxt_differential_robot/Rmotor")
