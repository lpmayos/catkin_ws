...
(cl:defmethod cl:initialize-instance :after ((m <Rencoder>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Rencoder)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lpmayos_ros_webots_epuck_nxt_differential_robot-msg:<Rencoder> is deprecated: use lpmayos_ros_webots_epuck_nxt_differential_robot-msg:Rencoder instead.")))

(cl:ensure-generic-function 'Rencoder-val :lambda-list '(m))
(cl:defmethod Rencoder-val ((m <Rencoder>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lpmayos_ros_webots_epuck_nxt_differential_robot-msg:Rencoder-val is deprecated.  Use lpmayos_ros_webots_epuck_nxt_differential_robot-msg:Rencoder instead.")
  (Rencoder m))

(cl:ensure-generic-function 'rotations-val :lambda-list '(m))
(cl:defmethod rotations-val ((m <Rencoder>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lpmayos_ros_webots_epuck_nxt_differential_robot-msg:rotations-val is deprecated.  Use lpmayos_ros_webots_epuck_nxt_differential_robot-msg:rotations instead.")
  (rotations m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Rencoder>)))
  ...
  "lpmayos_ros_webots_epuck_nxt_differential_robot/Rencoder")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Rencoder)))
  "Returns string type for a message object of type 'Rencoder"
  "lpmayos_ros_webots_epuck_nxt_differential_robot/Rencoder")
