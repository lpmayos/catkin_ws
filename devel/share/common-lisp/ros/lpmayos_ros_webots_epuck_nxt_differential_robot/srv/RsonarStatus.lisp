...
(cl:defmethod cl:initialize-instance :after ((m <RsonarStatus-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RsonarStatus-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lpmayos_ros_webots_epuck_nxt_differential_robot-srv:<RsonarStatus-request> is deprecated: use lpmayos_ros_webots_epuck_nxt_differential_robot-srv:RsonarStatus-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RsonarStatus-request>)))
  ...
  "lpmayos_ros_webots_epuck_nxt_differential_robot/RsonarStatusRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RsonarStatus-request)))
  "Returns string type for a service object of type 'RsonarStatus-request"
  "lpmayos_ros_webots_epuck_nxt_differential_robot/RsonarStatusRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <RsonarStatus-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RsonarStatus-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lpmayos_ros_webots_epuck_nxt_differential_robot-srv:<RsonarStatus-response> is deprecated: use lpmayos_ros_webots_epuck_nxt_differential_robot-srv:RsonarStatus-response instead.")))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <RsonarStatus-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lpmayos_ros_webots_epuck_nxt_differential_robot-srv:distance-val is deprecated.  Use lpmayos_ros_webots_epuck_nxt_differential_robot-srv:distance instead.")
  (distance m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RsonarStatus-response>)))
  ...
  "lpmayos_ros_webots_epuck_nxt_differential_robot/RsonarStatusResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RsonarStatus-response)))
  "Returns string type for a service object of type 'RsonarStatus-response"
  "lpmayos_ros_webots_epuck_nxt_differential_robot/RsonarStatusResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RsonarStatus)))
  ...
  "lpmayos_ros_webots_epuck_nxt_differential_robot/RsonarStatus")