...
(cl:defclass <Rrobot> (roslisp-msg-protocol:ros-message)
  ((Rrobot
   ...
   (leftMotor
    :reader leftMotor
    :initarg :leftMotor
    :type ros_lab2task2a-msg:Rmotor
    :initform (cl:make-instance 'ros_lab2task2a-msg:Rmotor))
   (rightMotor
    :reader rightMotor
    :initarg :rightMotor
    :type ros_lab2task2a-msg:Rmotor
...
(cl:defmethod cl:initialize-instance :after ((m <Rrobot>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Rrobot)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_lab2task2a-msg:<Rrobot> is deprecated: use ros_lab2task2a-msg:Rrobot instead.")))

(cl:ensure-generic-function 'Rrobot-val :lambda-list '(m))
(cl:defmethod Rrobot-val ((m <Rrobot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_lab2task2a-msg:Rrobot-val is deprecated.  Use ros_lab2task2a-msg:Rrobot instead.")
  (Rrobot m))

(cl:ensure-generic-function 'leftMotor-val :lambda-list '(m))
(cl:defmethod leftMotor-val ((m <Rrobot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_lab2task2a-msg:leftMotor-val is deprecated.  Use ros_lab2task2a-msg:leftMotor instead.")
  (leftMotor m))

(cl:ensure-generic-function 'rightMotor-val :lambda-list '(m))
(cl:defmethod rightMotor-val ((m <Rrobot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_lab2task2a-msg:rightMotor-val is deprecated.  Use ros_lab2task2a-msg:rightMotor instead.")
  (rightMotor m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Rrobot>)))
  ...
  (cl:format cl:nil "Header Rrobot~%ros_lab2task2a/Rmotor leftMotor~%ros_lab2task2a/Rmotor rightMotor~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: ros_lab2task2a/Rmotor~%Header Rmotor~%uint32 power~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Rrobot)))
  "Returns full string definition for message of type 'Rrobot"
  (cl:format cl:nil "Header Rrobot~%ros_lab2task2a/Rmotor leftMotor~%ros_lab2task2a/Rmotor rightMotor~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: ros_lab2task2a/Rmotor~%Header Rmotor~%uint32 power~%~%~%"))
