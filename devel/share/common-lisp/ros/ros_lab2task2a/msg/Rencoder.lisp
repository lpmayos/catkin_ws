...
(cl:defmethod cl:initialize-instance :after ((m <Rencoder>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Rencoder)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_lab2task2a-msg:<Rencoder> is deprecated: use ros_lab2task2a-msg:Rencoder instead.")))

(cl:ensure-generic-function 'Rencoder-val :lambda-list '(m))
(cl:defmethod Rencoder-val ((m <Rencoder>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_lab2task2a-msg:Rencoder-val is deprecated.  Use ros_lab2task2a-msg:Rencoder instead.")
  (Rencoder m))

(cl:ensure-generic-function 'rotations-val :lambda-list '(m))
(cl:defmethod rotations-val ((m <Rencoder>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_lab2task2a-msg:rotations-val is deprecated.  Use ros_lab2task2a-msg:rotations instead.")
  (rotations m))

(cl:ensure-generic-function 'on-val :lambda-list '(m))
(cl:defmethod on-val ((m <Rencoder>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_lab2task2a-msg:on-val is deprecated.  Use ros_lab2task2a-msg:on instead.")
  (on m))
