...
(cl:defmethod cl:initialize-instance :after ((m <RsonarStatus-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RsonarStatus-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_lab2task2-srv:<RsonarStatus-request> is deprecated: use ros_lab2task2-srv:RsonarStatus-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RsonarStatus-request>)))
  ...
  "ros_lab2task2/RsonarStatusRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RsonarStatus-request)))
  "Returns string type for a service object of type 'RsonarStatus-request"
  "ros_lab2task2/RsonarStatusRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <RsonarStatus-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RsonarStatus-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_lab2task2-srv:<RsonarStatus-response> is deprecated: use ros_lab2task2-srv:RsonarStatus-response instead.")))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <RsonarStatus-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_lab2task2-srv:distance-val is deprecated.  Use ros_lab2task2-srv:distance instead.")
  (distance m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RsonarStatus-response>)))
  ...
  "ros_lab2task2/RsonarStatusResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RsonarStatus-response)))
  "Returns string type for a service object of type 'RsonarStatus-response"
  "ros_lab2task2/RsonarStatusResponse")
