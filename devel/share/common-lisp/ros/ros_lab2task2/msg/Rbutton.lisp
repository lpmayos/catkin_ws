...
(cl:defmethod cl:initialize-instance :after ((m <Rbutton>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Rbutton)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_lab2task2-msg:<Rbutton> is deprecated: use ros_lab2task2-msg:Rbutton instead.")))

(cl:ensure-generic-function 'Rbutton-val :lambda-list '(m))
(cl:defmethod Rbutton-val ((m <Rbutton>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_lab2task2-msg:Rbutton-val is deprecated.  Use ros_lab2task2-msg:Rbutton instead.")
  (Rbutton m))
