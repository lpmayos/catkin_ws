...
(cl:defmethod cl:initialize-instance :after ((m <RbuttonStatus-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RbuttonStatus-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_webots_epuck_nxt_differential_robot-srv:<RbuttonStatus-request> is deprecated: use ros_webots_epuck_nxt_differential_robot-srv:RbuttonStatus-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RbuttonStatus-request>)))
  ...
  "ros_webots_epuck_nxt_differential_robot/RbuttonStatusRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RbuttonStatus-request)))
  "Returns string type for a service object of type 'RbuttonStatus-request"
  "ros_webots_epuck_nxt_differential_robot/RbuttonStatusRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <RbuttonStatus-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RbuttonStatus-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_webots_epuck_nxt_differential_robot-srv:<RbuttonStatus-response> is deprecated: use ros_webots_epuck_nxt_differential_robot-srv:RbuttonStatus-response instead.")))

(cl:ensure-generic-function 'left_pressed-val :lambda-list '(m))
(cl:defmethod left_pressed-val ((m <RbuttonStatus-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_webots_epuck_nxt_differential_robot-srv:left_pressed-val is deprecated.  Use ros_webots_epuck_nxt_differential_robot-srv:left_pressed instead.")
  (left_pressed m))

(cl:ensure-generic-function 'right_pressed-val :lambda-list '(m))
(cl:defmethod right_pressed-val ((m <RbuttonStatus-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_webots_epuck_nxt_differential_robot-srv:right_pressed-val is deprecated.  Use ros_webots_epuck_nxt_differential_robot-srv:right_pressed instead.")
  (right_pressed m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RbuttonStatus-response>)))
  ...
  "ros_webots_epuck_nxt_differential_robot/RbuttonStatusResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RbuttonStatus-response)))
  "Returns string type for a service object of type 'RbuttonStatus-response"
  "ros_webots_epuck_nxt_differential_robot/RbuttonStatusResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RbuttonStatus)))
  ...
  "ros_webots_epuck_nxt_differential_robot/RbuttonStatus")