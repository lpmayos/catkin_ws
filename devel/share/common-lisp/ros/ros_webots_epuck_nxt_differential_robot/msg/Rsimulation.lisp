...
(cl:defmethod cl:initialize-instance :after ((m <Rsimulation>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Rsimulation)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_webots_epuck_nxt_differential_robot-msg:<Rsimulation> is deprecated: use ros_webots_epuck_nxt_differential_robot-msg:Rsimulation instead.")))

(cl:ensure-generic-function 'Rsimulation-val :lambda-list '(m))
(cl:defmethod Rsimulation-val ((m <Rsimulation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_webots_epuck_nxt_differential_robot-msg:Rsimulation-val is deprecated.  Use ros_webots_epuck_nxt_differential_robot-msg:Rsimulation instead.")
  (Rsimulation m))

(cl:ensure-generic-function 'left_pressed-val :lambda-list '(m))
(cl:defmethod left_pressed-val ((m <Rsimulation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_webots_epuck_nxt_differential_robot-msg:left_pressed-val is deprecated.  Use ros_webots_epuck_nxt_differential_robot-msg:left_pressed instead.")
  (left_pressed m))

(cl:ensure-generic-function 'right_pressed-val :lambda-list '(m))
(cl:defmethod right_pressed-val ((m <Rsimulation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_webots_epuck_nxt_differential_robot-msg:right_pressed-val is deprecated.  Use ros_webots_epuck_nxt_differential_robot-msg:right_pressed instead.")
  (right_pressed m))

(cl:ensure-generic-function 'sonar_value-val :lambda-list '(m))
(cl:defmethod sonar_value-val ((m <Rsimulation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_webots_epuck_nxt_differential_robot-msg:sonar_value-val is deprecated.  Use ros_webots_epuck_nxt_differential_robot-msg:sonar_value instead.")
  (sonar_value m))

(cl:ensure-generic-function 'light_value-val :lambda-list '(m))
(cl:defmethod light_value-val ((m <Rsimulation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_webots_epuck_nxt_differential_robot-msg:light_value-val is deprecated.  Use ros_webots_epuck_nxt_differential_robot-msg:light_value instead.")
  (light_value m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Rsimulation>)))
  ...
  "ros_webots_epuck_nxt_differential_robot/Rsimulation")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Rsimulation)))
  "Returns string type for a message object of type 'Rsimulation"
  "ros_webots_epuck_nxt_differential_robot/Rsimulation")
