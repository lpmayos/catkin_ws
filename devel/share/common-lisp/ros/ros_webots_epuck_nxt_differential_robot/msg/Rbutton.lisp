...
(cl:defmethod cl:initialize-instance :after ((m <Rbutton>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Rbutton)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_webots_epuck_nxt_differential_robot-msg:<Rbutton> is deprecated: use ros_webots_epuck_nxt_differential_robot-msg:Rbutton instead.")))

(cl:ensure-generic-function 'Rbutton-val :lambda-list '(m))
(cl:defmethod Rbutton-val ((m <Rbutton>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_webots_epuck_nxt_differential_robot-msg:Rbutton-val is deprecated.  Use ros_webots_epuck_nxt_differential_robot-msg:Rbutton instead.")
  (Rbutton m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Rbutton>)))
  ...
  "ros_webots_epuck_nxt_differential_robot/Rbutton")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Rbutton)))
  "Returns string type for a message object of type 'Rbutton"
  "ros_webots_epuck_nxt_differential_robot/Rbutton")
