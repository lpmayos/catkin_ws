...
(cl:defmethod cl:initialize-instance :after ((m <Rsonar>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Rsonar)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_webots_epuck_nxt_differential_robot-msg:<Rsonar> is deprecated: use ros_webots_epuck_nxt_differential_robot-msg:Rsonar instead.")))

(cl:ensure-generic-function 'Rsonar-val :lambda-list '(m))
(cl:defmethod Rsonar-val ((m <Rsonar>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_webots_epuck_nxt_differential_robot-msg:Rsonar-val is deprecated.  Use ros_webots_epuck_nxt_differential_robot-msg:Rsonar instead.")
  (Rsonar m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Rsonar>)))
  ...
  "ros_webots_epuck_nxt_differential_robot/Rsonar")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Rsonar)))
  "Returns string type for a message object of type 'Rsonar"
  "ros_webots_epuck_nxt_differential_robot/Rsonar")
