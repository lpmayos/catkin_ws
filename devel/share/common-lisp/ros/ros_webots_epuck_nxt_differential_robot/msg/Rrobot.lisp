...
(cl:defclass <Rrobot> (roslisp-msg-protocol:ros-message)
  ((Rrobot
   ...
   (sonarSwitch
    :reader sonarSwitch
    :initarg :sonarSwitch
    :type ros_webots_epuck_nxt_differential_robot-msg:Rsonar
    :initform (cl:make-instance 'ros_webots_epuck_nxt_differential_robot-msg:Rsonar)))
)
...
(cl:defmethod sonarSwitch-val ((m <Rrobot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_webots_epuck_nxt_differential_robot-msg:sonarSwitch-val is deprecated.  Use ros_webots_epuck_nxt_differential_robot-msg:sonarSwitch instead.")
  (sonarSwitch m))
